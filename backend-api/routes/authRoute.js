...
router.post('/register', async (req, res) => {
    try {
        const { username, password, soTaiKhoanBank, tenNganHang } = req.body; 
        ...
        const newUser = new User({ username, password: hashedPassword, soTaiKhoanBank, tenNganHang });
        await newUser.save();
...
router.post('/login', async (req, res) => {
    try {
        ...
        const userInfo = { 
            ...
            phoneNumber: user.phoneNumber, soTaiKhoanBank: user.soTaiKhoanBank, 
